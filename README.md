...
```groovy
    ...
    dependencies {
        //implementation "io.projectreactor.kotlin:reactor-kotlin-extensions:1.2.7-SNAPSHOT"
        implementation "io.projectreactor.kotlin:reactor-kotlin-extensions:1.2.6"
    }
```
