...
```groovy
    ...
    dependencies {
      //compile "io.projectreactor.kotlin:reactor-kotlin-extensions:1.0.6.BUILD-SNAPSHOT"
      compile "io.projectreactor.kotlin:reactor-kotlin-extensions:1.0.5.RELEASE"
    }
```
